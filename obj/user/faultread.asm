         ...
         int padc)
{
  ...
  8001ea:	0f be 80 c8 0e 80 00 	movsbl 0x800ec8(%eax),%eax
  8001f1:	50                   	push   %eax
...
00800299 <vprintfmt>:
{
  ...
  8003dd:	52                   	push   %edx
  8003de:	68 e9 0e 80 00       	push   $0x800ee9
  8003e3:	56                   	push   %esi
  8003e4:	53                   	push   %ebx
  ...
  8003f2:	50                   	push   %eax
  8003f3:	68 e0 0e 80 00       	push   $0x800ee0
  8003f8:	56                   	push   %esi
  8003f9:	53                   	push   %ebx
  ...
  800414:	b8 d9 0e 80 00       	mov    $0x800ed9,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8009f7:	68 04 11 80 00       	push   $0x801104
  8009fc:	6a 1e                	push   $0x1e
  8009fe:	68 21 11 80 00       	push   $0x801121
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c1b:	56                   	push   %esi
  800c1c:	50                   	push   %eax
  800c1d:	68 30 11 80 00       	push   $0x801130
  ...
  800c2e:	e8 be f4 ff ff       	call   8000f1 <vcprintf>
	cprintf("\n");
  800c33:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
