...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 20 80 00 a0 	movl   $0x800ea0,0x802000
  800040:	0e 80 00 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000e1:	68 af 0e 80 00       	push   $0x800eaf
  8000e6:	6a 1e                	push   $0x1e
  8000e8:	68 cc 0e 80 00       	push   $0x800ecc
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800305:	56                   	push   %esi
  800306:	50                   	push   %eax
  800307:	68 dc 0e 80 00       	push   $0x800edc
  ...
  800318:	e8 56 00 00 00       	call   800373 <vcprintf>
	cprintf("\n");
  80031d:	c7 04 24 ff 0e 80 00 	movl   $0x800eff,(%esp)
         ...
         int padc)
{
  ...
  80046c:	0f be 80 01 0f 80 00 	movsbl 0x800f01(%eax),%eax
  800473:	50                   	push   %eax
...
0080051b <vprintfmt>:
{
  ...
  80065f:	52                   	push   %edx
  800660:	68 22 0f 80 00       	push   $0x800f22
  800665:	56                   	push   %esi
  800666:	53                   	push   %ebx
  ...
  800674:	50                   	push   %eax
  800675:	68 19 0f 80 00       	push   $0x800f19
  80067a:	56                   	push   %esi
  80067b:	53                   	push   %ebx
  ...
  800696:	b8 12 0f 80 00       	mov    $0x800f12,%eax
