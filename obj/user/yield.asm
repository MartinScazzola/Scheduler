...
umain(int argc, char **argv)
{
  ...
  80006a:	53                   	push   %ebx
  80006b:	50                   	push   %eax
  80006c:	68 08 0f 80 00       	push   $0x800f08
  ...
  80008f:	52                   	push   %edx
  800090:	50                   	push   %eax
  800091:	68 38 0f 80 00       	push   $0x800f38
         ...
         int padc)
{
  ...
  80023f:	0f be 80 68 0f 80 00 	movsbl 0x800f68(%eax),%eax
  800246:	50                   	push   %eax
...
008002ee <vprintfmt>:
{
  ...
  800359:	ff 24 85 20 10 80 00 	jmp    *0x801020(,%eax,4)
  ...
  800427:	8b 14 85 80 11 80 00 	mov    0x801180(,%eax,4),%edx
  80042e:	85 d2                	test   %edx,%edx
  800430:	74 15                	je     800447 <vprintfmt+0x159>
				printfmt(putch, putdat, "%s", p);
  800432:	52                   	push   %edx
  800433:	68 89 0f 80 00       	push   $0x800f89
  800438:	56                   	push   %esi
  800439:	53                   	push   %ebx
  ...
  800447:	50                   	push   %eax
  800448:	68 80 0f 80 00       	push   $0x800f80
  80044d:	56                   	push   %esi
  80044e:	53                   	push   %ebx
  ...
  800469:	b8 79 0f 80 00       	mov    $0x800f79,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a4c:	68 a4 11 80 00       	push   $0x8011a4
  800a51:	6a 1e                	push   $0x1e
  800a53:	68 c1 11 80 00       	push   $0x8011c1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c70:	56                   	push   %esi
  800c71:	50                   	push   %eax
  800c72:	68 d0 11 80 00       	push   $0x8011d0
  ...
  800c83:	e8 be f4 ff ff       	call   800146 <vcprintf>
	cprintf("\n");
  800c88:	c7 04 24 f3 11 80 00 	movl   $0x8011f3,(%esp)
